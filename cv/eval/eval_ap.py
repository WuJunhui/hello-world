...
# reference fast/er R-CNN voc_eval.py
...
#detfile='det_result.txt'
detfile='resultmtcnn.txt'
with open(detfile,'r') as f:
    lines=f.readlines()
splitlines=[x.strip().split(' ') for x in lines]
#image_ids=[imagenames.index(x[0].split('.')[0]) for x in splitlines]
